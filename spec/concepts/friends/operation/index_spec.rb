  ...
  describe "#perform!" do
    ...
    context "when user is authorized" do
      ...
      it "returns only accepted friendships where user is involved" do
        ...
        expect(friendships).to include(accepted_friendship1, accepted_friendship2)
        expect(friendships).not_to include(pending_friendship, blocked_friendship, unrelated_friendship)
      end
